    ...
    build_generator : function (seed) {
        ...
        return function (host) {
            ...
            return function (passwd) {
                ...
                return mods(RNDPHRASE.pack(H(H(H(passwd + '$' + host) + seed) + passwd)));
            };
        };
    },
    // set_seed :: String -> ()
...
function add_pw_junk(s)  { return "!A" + s;}
function add_pw_junk2(s) { return "A" + s;}
function add_pw_junk3(s) { return "9A" + s;}

RNDPHRASE.mods = [
    { pattern: /ku\.dk/,            fn: add_pw_junk  }, 
    { pattern: /itslearning\.com/,  fn: add_pw_junk  }, 
    { pattern: /prosa\.dk/,         fn: add_pw_junk  }, 
    { pattern: /dk-hostmaster\.dk/, fn: add_pw_junk  },
    { pattern: /au\.dk/,            fn: add_pw_junk2 },
    { pattern: /github\.com/,       fn: add_pw_junk3 }, 
];
